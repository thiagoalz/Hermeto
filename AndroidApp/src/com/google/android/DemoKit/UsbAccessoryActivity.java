...
import net.thiagoalz.hermeto.HermetoActivity;
...
public final class UsbAccessoryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = new Intent(this, HermetoActivity.class);//DemoKitLaunch.createIntent(this);
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK
				| Intent.FLAG_ACTIVITY_CLEAR_TOP);
		try {
			startActivity(intent);
		} catch (ActivityNotFoundException e) {
			Log.e(TAG, "unable to start Hermeto activity", e);
		}
		finish();
	}
}
